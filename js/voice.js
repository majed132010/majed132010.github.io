...
// ✅ FIX: AudioContext واحد مشترك — لا يُنشأ من جديد في كل مكالمة
...
function startSpeakingDetection(localTrack) {
 ...
 // ✅ إذا كان معلقاً (suspended)، استأنفه
 ...
 // أعد ربط المصدر إذا تغير المسار
...
async function leaveVoice() {
 ...
 try {
 stopSpeakingDetection(); // ✅ يُغلق AudioContext هنا
